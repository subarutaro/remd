...
#undef HostMalloc
  ...
  for(unsigned int rep=0;rep<nreplica;rep++){
    for(unsigned int i=0;i<nmol;i++){
      ...
      /*
      std::cout << "(vel) " << i;
      std::cout << " " << vel[nmol*rep + i].x;
      std::cout << " " << vel[nmol*rep + i].y;
      std::cout << " " << vel[nmol*rep + i].z;
      std::cout << " " << vel[nmol*rep + i].w;
      std::cout << std::endl;
      //*/
      ...
      /*
      std::cout << "(force) " << i;
      std::cout << " " << force[nmol*rep + i].x;
      std::cout << " " << force[nmol*rep + i].y;
      std::cout << " " << force[nmol*rep + i].z;
      std::cout << std::endl;
      //*/
      ...
      /*
      std::cout << "(angle) " << i;
      std::cout << " " << angle[nmol*rep + i].x;
      std::cout << " " << angle[nmol*rep + i].y;
      std::cout << " " << angle[nmol*rep + i].z;
      std::cout << " " << angle[nmol*rep + i].w;
      std::cout << std::endl;
      //*/
      ...
      /*
      std::cout << "(angvel) " << i;
      std::cout << " " << angvel[nmol*rep + i].x;
      std::cout << " " << angvel[nmol*rep + i].y;
      std::cout << " " << angvel[nmol*rep + i].z;
      std::cout << " " << angvel[nmol*rep + i].w;
      std::cout << std::endl;
      //*/
      ...
      /*
      std::cout << "(torque) " << i;
      std::cout << " " << torque[nmol*rep + i].x;
      std::cout << " " << torque[nmol*rep + i].y;
      std::cout << " " << torque[nmol*rep + i].z;
      std::cout << " " << torque[nmol*rep + i].w;
      std::cout << std::endl;
      //*/
    }
...
static const float max_aspect_ratio = 4.0f / 1.0f;
 // Pv/W * dt/2 = Pv/2W * dt
